...
int main() {
    std::cout << "=== SB-Tree 简单插入吞吐量测试 ===" << std::endl;
    ...
    for (int num_threads : thread_counts) {
        ...
        double throughput = static_cast<double>(success_count.load()) / duration.count() * 1000;
        ...
        std::cout << "       " << num_threads << "            " 
                  ...
                  << std::setprecision(1) << success_rate << "%" << std::endl;
    }
